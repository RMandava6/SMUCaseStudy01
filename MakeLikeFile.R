...
#Ramya Mandava
#Updated 07/02/2017
#Influenced by "Reproducible Research with R and R-Studio by Christopher Gandrud
###############################################################################
...
##Analysis
##Beers and Breweries data has been cleaned and merged for analysis. The below table shows, number of breweries present in each
##state.
